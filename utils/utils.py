...
def load_corpus(dataset_str):
    ...
    names = ['x', 'y', 'tx', 'ty', 'allx', 'ally',
             'adj', 'adj_pmi', 'adj_tfidf', 'adj_nf', 'adj_ff']
    objects = []
    ...
    x, y, tx, ty, allx, ally, adj, adj_pmi, adj_tfidf, adj_nf, adj_ff = tuple(
        objects)
    '''
        features -> node_size, word_embed_dim (List of List format sparse)
    ...
    return adj, adj_pmi, adj_tfidf, adj_nf, adj_ff, features, y_train, y_val, y_test, train_mask, val_mask, test_mask, train_size, test_size
