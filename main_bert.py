...
# study.optimize(BertObjective(param_dict, v), n_trials=1)
# joblib.dump(
#     study,
...
# v.patience = 20
# bert_fine_tuner = BertTrainer(configure_bert_trainer_inputs(v))
...
# cls_logits, input_embeddings = bert_fine_tuner.generate_embeddings_and_logits()
# torch.save(
#     cls_logits,
...
bert_fine_tuner.v.model.load_state_dict(torch.load(w_path))

with torch.no_grad():
    _, test_w_f1, test_macro, test_micro, test_acc = bert_fine_tuner.eval_model(
        phase="test"
    )
