...
print("Number of training documents: " + str(len(train_ids)))
random.shuffle(train_ids)

# Store train idxs in seperate file
...
# Obtain the shuffled version of the data
...
# build dictonary to detect which unique word appeared in which ids
word_doc_list = {}
...
# build frequency dictionary for unique words
word_doc_freq = {}
...
# As a side not, word_vector_map is empty, maybe they tried word2vec or different variations but it
# just not worked
