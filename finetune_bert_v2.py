...
study.optimize(BertObjective(param_dict, v_bert), n_trials=2)
joblib.dump(
    study, "{}/hyperparam-studies/{}.pkl".format(v_bert.dataset, study.study_name)
)
...
hyperparamstudy_path = os.path.join(
    project_path, "{}/hyperparam-studies".format(v_bert.dataset)
)


#%%

best_study = find_best_study(hyperparamstudy_path="hyperparam-studies")
