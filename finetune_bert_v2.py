...
def objective(trial):
    # bert_lr = trial.suggest_float("bert_lr", 1e-5, 1.1 * 1e-5, log=True)
    batch_size = trial.suggest_categorical("batch_size", [32])
    max_length = trial.suggest_categorical("max_length", [256])
    bert_init = trial.suggest_categorical("bert_init", ["roberta-base"])
