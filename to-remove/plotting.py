...
markers = ["o", "o", "o", "o", "v", "v", "v"]
# colors = ["#1f77b4"] * 4 + ["#ff7f0e", "#9467bd", "#d62728"]
...
ax.annotate(s[3], (x[3] - 45, y[3] + 0.3), fontsize=fontsize_m)
...
plt.show()
fig.savefig("results/relative_train_time.eps", format="eps")
